...
fixture `Home` // declare the fixture
    .page `http://localhost:8180`; // specify the start page

// we can define a client function that will run on the client side.
...
test('can see the user page by clicking a user url', async t => {
    await t
        ...
        .expect(Selector('.user-view.view')).ok('the user view has been loaded');
});
